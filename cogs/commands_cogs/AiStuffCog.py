...
class AiStuffCog(commands.Cog):
    ...
    async def imagine_poly(self, ctx: commands.Context, prompt: str, images: int = 4):
    ...
    async def imagine(
        ...
        if negative is not None:
            embed.add_field(
                name="📝 Negative Prompt", value=f"- {negative}", inline=False
            )
